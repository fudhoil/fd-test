...
const Sidebar = () => {
    return (
        <div className="bg-[#151A2E] min-h-screen hidden lg:flex lg:flex-col">
            <div className="bg-[#171E37] overflow-hidden h-screen w-[250px]">
                <div className="flex flex-col gap-4 p-[20px]">
                    <div className="flex flex-row gap-4">
                        <img src="/icons/logo.png" alt="logo" />
                    </div>
                    <div className="flex flex-col p-0 pt-[30px]">
                        <button className="flex flex-row gap-4 items-center bg-[#1F2849] py-4 px-[12px] rounded-lg">
                            <img className="h-[20px] w-[20px]" src="/icons/home.png" alt="home" />
                            <p className="text-[#6C747D] text-[16px] font-medium">Home</p>
                        </button>
                        <button className="flex flex-row gap-4 items-center hover:bg-[#1F2849] py-4 px-[12px] rounded-lg">
