            ...
            <div className="flex flex-row gap-6 justify-between m-auto">
                ...
                <div className="bg-[#1C243F] rounded-lg w-[128.75px] relative">
                    ...
                    <div style={{
                        ...
                        background: `conic-gradient(#0BB885 0% ${totalSales / 330 * 100}%, #1F2849 ${totalSales / 330 * 100}% 100%)`,
                        display: 'flex',
                    ...
                    <div style={{
                        ...
                        // border: '11px solid #0BB885',
                        background: `conic-gradient(#FF814A 0% ${totalOrders / 330 * 100}%, #1F2849 ${totalOrders / 330 * 100}% 100%)`,
                        justifyContent: 'center',
                        alignItems: 'center',
                        position: 'absolute',
                        top: '7px',
